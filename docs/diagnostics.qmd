...
The diagnostics object also reports a linear projection of the pseudo-outcome on
an intercept and the input CATE score. This is the compact calibration-style
linear diagnostic used in the Chernozhukov-style HTE evaluation literature.
Its confidence intervals and p-values reuse the same `fold_ids` /
`jackknife_folds` split as the main diagnostics output.
