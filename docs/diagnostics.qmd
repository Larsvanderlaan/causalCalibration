...
This is especially important for `loss="r"` workflows. The fitted calibrator targets the overlap-weighted population, so the overlap-targeted diagnostic is the natural companion summary. The DR diagnostic is still useful when you want to ask how the same predictor behaves for the original population.
