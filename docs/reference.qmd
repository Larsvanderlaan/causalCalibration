...
Use when you want a quick overlap summary before choosing `loss="dr"` versus `loss="r"`.

### Outputs

- propensity min/max,
- tail fractions below `0.05`, `0.10`, above `0.90`, `0.95`,
- clipped fraction,
- IPW effective sample size,
- overlap-weight effective sample size,
- severity label and recommended loss.
